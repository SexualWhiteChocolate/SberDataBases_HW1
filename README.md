...
То есть Scylla это прям суперраспределенная, без какого либо центра система (что позволяет достучаться до неё в любой момент времени), в которой есть отдельная поддержка сохранения consistency и возможность к её тюнингу. Ясно, что назвать её принадлежащий к классу AP самый - логичный вывод 
